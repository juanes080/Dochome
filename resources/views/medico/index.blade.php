        ...
        <section class="centrar">
            ...
            <nav class="menu-principal">
                <ul>
                    ...
                    <li class="navs"><a href="{{ url('/miscitas') }}">Mis citas</a></li>
                    @if (auth()->check())
                        {{--  <li class="mx-8">
                        ...
                        <li class="menuu">
                            ...
                            <div class="dropdown-menu dropdown-menu-dark text-small shadow"
                                ...
                                <a style="color: white" class="dropdown-item" href="{{ 'perfilmedico/create' }}">Ver
                                    Perfil</a>
                                {{-- <a style="color: white" class="dropdown-item" href="{{route('perfil.perfilmedico')}}"> Editar Perfil</a> --}}
