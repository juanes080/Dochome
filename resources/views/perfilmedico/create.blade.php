        ...
        <section class="body_major">
            <section class="box_left">
                <article class="box_top">
                    ...
                    <div>
                        <a href="{{ route('perfil.perfilmedico') }}" type="submit" class="botonnn btn"
            ...
            <section class="box_right">
                ...
                {{-- <article class="labels_right">
                    <label for="contraseña" class="form-label"><b style="color: #115679">Especialidad</b> </label>
                    <b class="machete letra">{{ auth()->user()->specialties }}</b>
                </article> --}}
            </section>
