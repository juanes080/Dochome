...
<head>
    ...
    <title>Perfil Administrador - Lista Administradores</title>
        ...
        @if (auth()->check())
            ...
            <li class="menuu">
                <p class="navv d-flex align-items-center text-white text-decoration-none dropdown-toggle"
                    ...
                    <img src=" {{ asset('file/' . auth()->user()->foto) }}" width="45" height="45"
    ...
    <section class="home-section">
        <article class="caja ">
            <section class="nombree">
                <h1>A D M I N I S T R A D O R E S</h1>
            </section>
            {{--  <section class="crear">
                <a href="{{ route('registroadmin.index') }}" type="submit" class="boton btn btn-success ">
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr class="letras redondeado2 cajas col-12 col-sm-4 col-md-8 col-lg-12">
                                <td>
                                    <div>
                                        <img src="{{ asset('file/' . $user->foto) }}" alt=""
                                            style="width: 45px; height: 45px" class="rounded-circle" />
                                    </div>
                                </td>
                                <td>
                                    <p >{{ $user->nombres_y_apellidos }}</p>
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr class="letras redondeado2 cajas col-12 col-sm-4 col-md-8 col-lg-12">
                                <td>
                                    <div>
                                        <img src=" {{ asset('file/' . $user->foto) }}" alt="" width="45"
