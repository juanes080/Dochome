...
<head>
    ...
    <title>Perfil Administrador - Lista Pacientes</title>
    ...
    <section class="home-section">
        <article class="caja ">
            <section class="nombree">
                <h1>P A C I E N T E S</h1>
            </section>
            <section class="cajita2">
                <table>
                    <thead class="titulo d-flex  titulo col-12 col-sm-4 col-md-8 col-lg-12 ">
                        <tr class="texto1">
                            <th scope="col"></th>
                    ...
                    <tbody>
                        @foreach ($patients as $paciente)
                            <tr class="letras redondeado2 cajas col-12 col-sm-4 col-md-8 col-lg-12">
                                <td>
                                  <div>
                                        <img src="{{ asset('file/' . $paciente->foto) }}" alt=""
                                            style="width: 45px; height: 45px" class="rounded-circle" />
                                    </div>
                                </td>
                                <td>
                                    <p >{{ $paciente->nombres_y_apellidos }}</p>
