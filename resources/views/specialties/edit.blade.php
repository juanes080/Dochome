...
<head>
    ...
    <title>Perfil Administrador - Editar Especialidades</title>
        ...
        @endif
            ...
            <section class="cajita2">
                ...
                <div class="nuevaespeci">
                    <form class="formespeci" action="{{ url('/especialidades/' . $specialty->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <br>
                        <div class="form-group row mb-4 especialidad">

                            <label class="form-label" style="color: #10A9FF;" for="name"> <b>Nombre de la
                                    Especialidad</b>
                            </label>
                        ...
                        <div class="col">
                            <button type="submit" class="btn1 btn btn-sm"
                                style="background-color: #10A9FF;  color: white; ">Guardar Especialidad</button>
                        </div>
